      ...
      <AppBar position="static" elevation={0}
        ...
        <MuiToolbar variant="dense" sx={{ minHeight: '50px !important', gap: 1 }}>
          ...
          <Typography component={Link} href="/" variant="subtitle1"
            sx={{ fontWeight: 700, color: PURPLE, textDecoration: 'none' }}>
            MachineLearning.js
          </Typography>
          <Typography variant="subtitle1" sx={{ color: '#bbb', mx: 0.5 }}>/</Typography>
          <Typography variant="subtitle1" sx={{ fontWeight: 600, color: PURPLE, flexGrow: 1 }}>
            BN Builder
          </Typography>
          <Button component={Link} href="/docs/k2/" size="small"
            sx={{ color: PURPLE, fontSize: 12, mr: 1 }}>
            K2 Docs
          </Button>
          <Button component="a" href="https://github.com/marink/machinelearning"
